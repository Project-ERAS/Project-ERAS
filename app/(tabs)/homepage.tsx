...
import { useRouter } from "expo-router";
import { useMemo, useState } from "react";import type { ImageSourcePropType } from "react-native";
import {
  Image
   ImageBackgroun,    ScrollViw,
    Statusar
    StyleSet,
   ext,
    TextIut,
  ...
  const quickActions = useMemo<QuickAction[]>(() => {
    return [
      ...
      },
      {
        ...
        type: "image",
        icon: require("@/assets/icons/livefeed.jpeg"),
        keywords: ["camera", "livUser e", "feed"        subtitle: "User-submitted information",
      {
        title: "Updates",
        subtitle: "Latest news",
        route: "/User-Updates",
        iconBackgroundColor: U#FFFUFF",
      ,equire("@/assets/icons/user updates.jpeg"),
        iconTintColor: "#000",
        keywords: ["updates", "news", "latest"],
      },
    ];
