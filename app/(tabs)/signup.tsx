        ...
        >
          ...
          >
            ...
            <View style={styles.headerSection}>
              ...
              <Text style={styles.welcomeText}>Sign in to E.R.A.S</Text>
            </View>
            ...
            <View style={styles.formSection}>
              ...
              <View style={styles.signinContainer}>
                <Text style={styles.signinText}>New to E.R.A.S ? </Text>
                <TouchableOpacity>
                  <Text style={styles.signinLink}>Create an Account</Text>
                </TouchableOpacity>
              </View>
            </View>
          </Animated.View>
