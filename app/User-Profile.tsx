...
export default function UserProfileScreen() {
	...
	return (
		<SafeAreaView style={[styles.safeArea, { backgroundColor: backgroundGreen }]}>
			<View style={[styles.headerSection, { backgroundColor: headerGreen }]}> 
				...
				<View style={[styles.avatarCircle, { backgroundColor: '#67C23A', shadowColor }]}>
			...
			>
				<View style={styles.fieldGroup}>
					...
					{isEditing ? (
						...
						<View style={[styles.inputCard, { backgroundColor: fieldBackground, shadowColor }]}> 
				...
				<View style={styles.fieldGroup}>
					<Text style={[styles.label, { color: headerGreen }]}>Phone number</Text>
					{isEditing ? (
						<TextInput
				...
				<View style={styles.actionsRow}>
					<Pressable
						...
						style={({ pressed }) => [
							styles.actionButton,
							{ backgroundColor: headerGreen, shadowColor, opacity: pressed ? 0.86 : 1 },
						]}
					>
						<Feather name={isEditing ? 'check' : 'edit-2'} size={23} color={buttonText} />
						<Text style={[styles.actionText, { color: buttonText }]}>{isEditing ? 'Save' : 'Edit'}</Text>
					</Pressable>
					...
					>
						...
						<Text style={[styles.actionText, { color: buttonText }]}>Logout</Text>
					</Pressable>
				</View>
			</ScrollView>
		</SafeAreaView>
